...
\end{center}
Les calculs sont présentés de la même façon que sous gamandua. Un nouveau calcul se lance en cliquant sur Fichier --\textgreater Nouvelle Simulation dans la barre d'outils.
